...
// set the proper format for value which is shown in grid data
 ...
 return(
    <div>
        ...
        <table className={classes.result}>
            ...
            <tbody>
                {/** props values to be mapped with respective column fields */}
                {props.data.map((yearlyData)=>(
                    <tr key={yearlyData.year}>
                     ...
                     <td>{formatter.format(yearlyData.savingsEndOfYear - props.initialInvestment -
